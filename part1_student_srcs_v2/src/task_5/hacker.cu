...
#define Xnum 26
#define Ynum 26
#define Lnum 4  // number of letters
...
__global__ void check_password(char *digests_GPU, const int *digests, int num_digests)
{
	...
	char passwd_temp[Lnum+1];
 	...
 	passwd_temp[2] = 'a' + threadIdx.x;
 	passwd_temp[3] = 'a' + threadIdx.y;
...
int main(int argc, char** args)
{
	...
	dim3 numBlocks(676/Xnum,676/Ynum);

	check_password <<<numBlocks, threadsPerBlock>>> (digests_GPU, digests_4letters, MAX_DG);
